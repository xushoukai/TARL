  ...
  def _build_train_op(self):
    ...
    if self.summary_writer is not None:
      with tf.variable_scope('Losses'):
        HuberLoss_summeary = tf.summary.scalar('HuberLoss', final_loss)
        merged_train_summaries = tf.compat.v1.summary.merge([HuberLoss_summeary])
        
    return self.optimizer.minimize(final_loss), loss, merged_train_summaries
=======
# coding=utf-8
# Copyright 2020 The Google Research Authors.
#
