...
flags.DEFINE_string('replay_dir', "/mnt/cephfs/home/lianzihao/code/transfer_rl/CQL/atari/datasets/Pong/1", 'Directory from which to load the '
                    'replay data')
# flags.DEFINE_boolean('adapted', False, 'The flag to adapt the model in test-time')
...
import sys
sys.path.append("/apdcephfs/share_1594716/lianzihao/code/transfer_rl/CQL/atari")
