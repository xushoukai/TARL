...
class FixedReplayRunner(run_experiment.Runner):
  ...
  def _run_eval_iteration(self, iteration):
    ...
    statistics = iteration_statistics.IterationStatistics()
    tf.logging.info('Starting iteration %d', iteration)
    num_episodes_eval, average_reward_eval, average_step_count = self._run_eval_phase(statistics)
    self._save_tensorboard_summaries(
        iteration, num_episodes_eval, average_reward_eval)
    
    if self._agent.adapted:
      adapted_num_episodes_eval, adapted_average_reward_eval, adapted_average_step_count = self._run_adapted_eval_phase(statistics)
      self._save_tta_tensorboard_summaries(
        iteration, num_episodes_eval, average_reward_eval, adapted_num_episodes_eval, adapted_average_reward_eval)
  ...
  #       adapted_num_episodes_eval, adapted_average_reward_eval, adapted_average_step_count = self._run_adapted_eval_phase(statistics)
  #       with open(result_path, "a+") as f:
  #         f.write("iteration: {}, entropy: {}, adapted_num_episodes_eval: {}, adapted_average_reward_eval: {}, adapted_average_step_count: {}\n".format(
  #           iteration, self._agent.entropy, adapted_num_episodes_eval, adapted_average_reward_eval, adapted_average_step_count))
  ...
  #     num_episodes_eval, average_reward_eval, average_step_count = self._run_eval_phase(statistics)
  #     with open(result_path, "a+") as f:
  #       f.write("iteration: {}, entropy: {}, num_episode_val: {}, average_reward_eval: {}, average_step_count: {}\n".format(
  #         iteration, self._agent.entropy, num_episodes_eval, average_reward_eval, average_step_count))
