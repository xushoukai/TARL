...
class CQLPolicyDiscreteQ(SACPolicyDiscrete):
    """
    ...
    def learn(self, batch: Dict) -> Dict[str, float]:
        ...
        random_ints = torch.randint(10, (batch_size * self._num_repeat_actions, actions.shape[-2]))
        # 使用scatter函数创建one-hot向量
        one_hot_vector = torch.zeros(batch_size * self._num_repeat_actions, actions.shape[-2], 10)
        ...
        critic1_loss = 10 * critic1_loss + conservative_loss1
        critic2_loss = 10 * critic2_loss + conservative_loss2
