...
def get_args():
    ...
    parser.add_argument("--checkpoints", type=str, default="/lichenghao/lch/transfer_rl-main/OfflineRL-Kit/log/walker2d-medium-v2/cql_ln_before_activation_best/seed_0&timestamp_25-0330-163702/checkpoint/best_policy.pth")
    ...
    parser.add_argument("--auto-alpha", default=False)
    ...
    parser.add_argument("--loss_agg_type", type=str)
    parser.add_argument("--is_entropy_filter", default=False)
...
def evaluate(args=get_args()):
    ...
    # train
    policy_trainer.evaluate(args.seed, args.only_eval_tta, args.weight_sample, use_mcd=True ,val_epoch=10, is_entropy_filter=args.is_entropy_filter, entropy_threshold=args.entropy_threshold, loss_agg_type=args.loss_agg_type)

    # policy_trainer.evaluate(args.seed, args.only_eval_tta, args.weight_sample, fixed_entropies=fixed_entropies)
