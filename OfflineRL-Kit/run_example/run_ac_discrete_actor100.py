...
from offlinerlkit.modules import ActorDiscrete100, Critic, TanhDiagGaussian
from offlinerlkit.utils.load_dataset import qlearning_dataset
from offlinerlkit.buffer import ReplayBuffer
from offlinerlkit.utils.logger import Logger, make_log_dirs
from offlinerlkit.policy_trainer import DiscreteMFPolicyTrainer100
from offlinerlkit.policy import SACPolicyDiscrete100
...
def get_args():
    ...
    parser.add_argument("--algo-name", type=str, default="ac_discrete_woentropy")
    ...
    parser.add_argument("--actor-tau", type=float, default=1e-4)
...
def train(args=get_args()):
    ...
    actor = ActorDiscrete100(actor_backbone, args.action_dim, args.device, args.actor_tau)
    ...
    policy_trainer = DiscreteMFPolicyTrainer100(
        policy=policy,
        eval_env=env,
        buffer=buffer,
        logger=logger,
